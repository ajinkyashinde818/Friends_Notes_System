...
//         ArrayList<String> clientData=new StudentDBOP().getClientdata();
//         System.out.println("Client Data:"+clientData);
                ...
                System.out.println("Client Data: " + clientData);
                 ...
                 if (dobParts.length == 3) {
                     jTextField2.setText(dobParts[0]); // DD
                     jTextField3.setText(dobParts[1]); // MM
                     jTextField4.setText(dobParts[2]); // YYYY
             }

            if (!clientData.isEmpty() && clientData.size() >= 10) {
                jTextField1.setText(clientData.get(1));  // name
                
                jTextField6.setText(clientData.get(4));//email
               
                jComboBox1.setSelectedItem(clientData.get(5));  // department
                jTextField5.setText(clientData.get(3));  //mobile
                jTextField8.setText(clientData.get(7));  // username
                jPasswordField1.setText(clientData.get(8));  // password
                jTextField7.setText(clientData.get(6));  // college
            } else {
    ...
    private void initComponents() {
        ...
        jPanel2.setBounds(470, 280, 720, 650);

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Student data edit frame.png"))); // NOI18N
        getContentPane().add(jLabel8);
        jLabel8.setBounds(0, 0, 1950, 1080);
    ...
    JOptionPane.showMessageDialog(this, "Please select a department");
        ...
        // Save to database
         ...
         if(new StudentDBOP().isStudentEdited(name, dob, mobile, email, dept, college, password, username)){
            JOptionPane.showMessageDialog(null," User Credetainls are Updated Successfully");
        }else{
